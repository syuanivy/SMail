...
BEGIN TRANSACTION;
CREATE TABLE users(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,username TXT NOT NULL, password TXT NOT NULL);
...
CREATE TABLE emails(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, sender TXT, recipient TXT, subject TXT, body TXT, attached INT DEFAULT 0);
